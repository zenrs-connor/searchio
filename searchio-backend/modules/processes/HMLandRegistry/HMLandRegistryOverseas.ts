...
export class HMLandRegistryOverseas extends HMLandRegistryProcess {
    
    
    protected id = "HMLandRegistryOverseas";           
    protected name: "Overseas companies that own property in England and Wales";
    ...
    public async process(): Promise<SearchioResponse> {
        ...
        try{
            ...
            await new Promise((resolve) => {
                ...
                const options = {
                    url: `https://use-land-property-data.service.gov.uk/api/v1/datasets/history/ocod/OCOD_FULL_2021_09.zip`,
                    headers: {
                        'User-Agent': 'request',
            ...
            if(!response.error) {
                ...
                return this.success(`Successfully performed a search for data on overseas companies that own property in England and Wales.`, response);
            ...
            return this.error(`(HMLandRegistryOverseas) Could not perform search for overseas companies that own property in England and Wales`, err);
        }
    }
}