...
import { RapidCarCheckProcess } from "./RapidCarCheckProcess";

export class RapidCarCheckStream extends RapidCarCheckProcess {


    protected id = "RapidCarCheckStream";           
    protected name: "Registration Plate Search";
        ...
        try{
            ...
            for(let element of elements){
                ...
                if(text == "Daily Lookup Limit"){
                    ...
                    return this.error(`(RapidCarCheckStream) Error daily lookup limit has been met`);
                }
            }

            return this.success(`(RapidCarCheckStream) Successfully loaded vehicle details`);
        } catch(err) {
            console.log(err);
            return this.error(`(RapidCarCheckStream) Error loading vehicle details`, err);
        }
    }
    ...
    public async scrapeVehicleInformation(reg: string): Promise<SearchioResponse> {
        try{
            ...
            return this.success(`(RapidCarCheckStream) Successfully scraped vehicle information`, carFormat);
        } catch(err) {
            console.log(err);
            return this.error(`(RapidCarCheckStream) Error scraping vehicle information`, err);
        }
    }
    ...
    public async scrapeMileageInformation(reg: string): Promise<SearchioResponse> {
        try{
            ...
            if(check.length == 0) {
                ...
                return this.success(`(RapidCarCheckStream) No mileage information available`, mileageFormat);
            } else {
                ...
                return this.success(`(RapidCarCheckStream) Successfully scraped vehicle mileage information`);
            }
        } catch(err) {
            console.log(err);
            return this.error(`(RapidCarCheckStream) Error scraping vehicle mileage information`, err);
        }
    }
    ...
    public async scrapeMOTHistory(reg: string): Promise<SearchioResponse> {
        try{
            ...
            return this.success(`(RapidCarCheckStream) Successfully scraped vehicle MOT history`);
        } catch(err) {
            console.log(err);
            return this.error(`(RapidCarCheckStream) Error scraping vehicle MOT history`, err);
        }
    }
    ...
    public async scrapeVehicleDetails(reg: string = this.query): Promise<SearchioResponse> {
        try{
            ...
            vehicleDetails.motHistory = motHistoryInformation

            return this.success(`(RapidCarCheckStream) Successfully scraped vehicle details`, vehicleDetails);
        } catch(err) {
